        ...
        <>
          <div className="mx-0 sm:px-4">
            <div className="flex px-4 py-1 items-center justify-between">
              ...
              {/* <div className="flex flex-col flex-shrink-0 justify-center items-center py-1 gap-1"> */}
              <button className="flex flex-col flex-shrink-0 justify-center items-center py-4 pr-4 gap-0.5 text-center" onClick={() => { setShowSpoonsModal(true); }}>
                { remainingSpoons > 3 ? (
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M10.025 11.4492L3.68505 6.42088C3.46973 6.25033 3.29292 6.03615 3.16624 5.79241C3.03956 5.54868 2.96588 5.28091 2.95002 5.00667C2.93417 4.73244 2.97651 4.45796 3.07426 4.20125C3.17201 3.94455 3.32295 3.71142 3.51719 3.51719C3.71142 3.32295 3.94455 3.17201 4.20125 3.07426C4.45796 2.97651 4.73244 2.93417 5.00667 2.95002C5.28091 2.96588 5.54868 3.03956 5.79241 3.16624C6.03615 3.29292 6.25033 3.46973 6.42088 3.68505L11.4492 10.025C12.5384 9.54922 14.1992 9.48505 15.5984 10.8834C16.4442 11.7301 16.9709 12.765 17.1509 13.75C17.3259 14.7084 17.1917 15.7717 16.4817 16.4817C15.7725 17.1917 14.7084 17.3259 13.7509 17.1509C12.7659 16.9709 11.73 16.4442 10.8842 15.5975C9.48422 14.1984 9.54922 12.5384 10.025 11.4492Z" fill="#0F0129" /></svg></div> </Badge>)
                  :
