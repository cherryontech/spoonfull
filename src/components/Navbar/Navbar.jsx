...
import { AppBar, Badge, useTheme, styled, ListItem, Divider, List, Drawer, ListItemButton, ListItemText, ListItemIcon } from '@mui/material'
...
const Navbar = ({
  ...
  // const pages = ["Home", "About Us", "Tutorial", "FAQ", "Share With Friends"];
            ...
            return (
              <ListItem>
                <ListItemButton
                  key={item.name}
                  to={item.href}>
                    <ListItemIcon style={{ color: "#001111" }}> {item.icon} </ListItemIcon>
                  {item.name}
                </ListItemButton>
              </ListItem>
            )
