            ...
            <article id="swipable" className="w-full min-w-[320px] mx-1 py-1 z-[2] bg-background transition ease-in-out">
                <div className={`bg-${task.background} shadow-card-shadow rounded-lg flex items-start justify-between pl-4`}>
                    <div className="flex py-4 items-center">
                        <input
                            className="peer appearance-none p-2.5 w-[24] h-[24] border rounded-sm mr-5 mt-1 shrink-0 checked:bg-white checked:border-text checked:border-1"
                            type="checkbox"
                            data-id="checkbox"
                            id="checkbox"
                            value={task.id}
                        ...
                        />
                        <svg
                            className="absolute w-4 h-4 mt-1 ml-[3px] hidden peer-checked:block pointer-events-none"
